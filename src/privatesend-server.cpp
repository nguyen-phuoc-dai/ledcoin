...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Led related functionality
...
/*
    ...
    allow endless transaction that would bloat Led and make it unusable. To
