 ...
 *
 *   // network
 *   CLedNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.led.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLedNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LedNetwork
// //   -- signature requirements : Key1(User)
// class CLedNetworkVariable : public CGovernanceObject
// {
// private:
