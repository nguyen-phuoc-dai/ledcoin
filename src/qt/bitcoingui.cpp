    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Led Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Led address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and led: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Led Core"), this);
    aboutAction->setStatusTip(tr("Show information about Led Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Led Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Led addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Led addresses"));
    ...
    openAction->setStatusTip(tr("Open a led: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Led Core help message to get a list with possible Led Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Led Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Led network", "", count));
    } else {
...
{
    QString strTitle = tr("Led Core"); // default title
