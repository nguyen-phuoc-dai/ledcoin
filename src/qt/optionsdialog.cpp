    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LED-light"), QVariant("light"));
    ui->theme->addItem(QString("LED-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LED-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LED-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LED-traditional"), QVariant("trad"));
