    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Led Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Led Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  led-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Led in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LED, 0.1 LED, 1 LED and 10 LED -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ledpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ledpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Led Core is shutting down...") + "<br /><br />" +
