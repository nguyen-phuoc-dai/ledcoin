...
Only requiring some minor changes is led.cpp.
...
Changes to led.cpp
----------------------
led.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
