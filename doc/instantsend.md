...
This mechanism has been integrated into Bitcore-Node-Led which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ledpay/insight-api-led#web-socket-api](https://github.com/ledpay/insight-api-led#web-socket-api)
* API: [https://github.com/ledpay/insight-api-led#instantsend-transactions](https://github.com/ledpay/insight-api-led#instantsend-transactions)
...
By default, the Led Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Led Core daemon:
